...
class Home extends BaseController
{
    ...
    public function index()
    {
        ...
        */
        ...
        $raffles = $raffleModel->select('id, winners, title, slug, draw_date', 'description','favoritar','images')->where(['status' => 2])->orderBy('id', 'DESC')->findAll(4);
        $raffles1 = $raffleModel->select('id, winners, title, slug, draw_date', 'description','favoritar','images')->where(['status' => 1])->orderBy('id', 'DESC')->findAll(4);
