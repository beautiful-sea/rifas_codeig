                    ...
                    <div class="raffle-box">
                        <div class="raffle-box-content">
                            ...
                            <div class="raffle-desc">
                                ...
                                <?php if($raffle->favoritar == 0): ?>

                                    <a class="raffle-active" style="color: green" href="<?php echo base_url('dashboard/toggle-favoritar')?>/<?php echo $raffle->id ?>"><i style="color: green" class="fa-solid fa-toggle-off"></i> Favoritar Rifa</a>

                                <?php else: ?>

                                    <a class="raffle-active" style="color: #b24848" href="<?php echo base_url('dashboard/toggle-favoritar')?>/<?php echo $raffle->id ?>"><i style="color: #b24848" class="fa-solid fa-toggle-on"></i> Desfavoritar Rifa</a>

                                <?php endif ?>
                                <br>

                                <?php if($raffle->status == 0 || $raffle->status == 2):?>
                                    <a class="raffle-active" style="color: green" href="<?php echo base_url('dashboard/toggle-encerra')?>/<?php echo $raffle->id ?>"><i style="color: green" class="fa-solid fa-toggle-off"></i> Ativar Rifa</a>
                                <?php else: ?>
                                    <a class="raffle-inactive" style="color: #b24848" href="<?php echo base_url('dashboard/toggle-encerra')?>/<?php echo $raffle->id ?>"><i style="color: #b24848" class="fa-solid fa-toggle-on"></i> Encerrar Rifa</a>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php if($raffle->status != 2): ?>
                                            ...
                                            <?php if($raffle->status == 0):?>
                                                <a class="raffle-active" style="margin-bottom: 5px;" href="<?php echo base_url('dashboard/toggle-raffle')?>/<?php echo $raffle->id ?>"><i class="fa-solid fa-toggle-off"></i> Ativar</a>
                                            <?php else: ?>
                                                <a class="raffle-inactive" style="margin-bottom: 5px;" href="<?php echo base_url('dashboard/toggle-raffle')?>/<?php echo $raffle->id ?>"><i class="fa-solid fa-toggle-on"></i> Desativar</a>
                                        ...
                                        <a class="raffle-info" style="margin-bottom: 5px;" href="<?php echo base_url('dashboard/pedidos')?>?id_raffle=<?php echo $raffle->id ?>" target="_blank"><i class="fa-solid fa-list"></i> Pedidos</a>

                                    <?php endif ?>

                                    <a class="raffle-edit" style="margin-bottom: 5px;" href="<?php echo base_url('dashboard/rifas/editar')?>/<?php echo $raffle->id ?>" class="raffle-edit" data-raffle=""><i class="fa-solid fa-pen-to-square"></i> Editar</a>
                                    <a class="raffle-delete" style="margin-bottom: 5px;" href="<?php echo base_url('dashboard/rifas/excluir')?>/<?php echo $raffle->id ?>" class="raffle-trash" onclick="return confirm('Tem certeza que deseja excluir a rifa e todos os seus pedidos?')"><i class="fa-solid fa-trash"></i> Excluir</a>
                                </div>
                                <div class="raffle-controls" style="margin-top: 5px;background-color: #606060;">
                                    <a class="raffle-pdf" target="_blank" href="<?php echo base_url('dashboard/gerarpdf')?>/<?php echo $raffle->id ?>" class="raffle-edit" data-raffle=""><i class="fa-solid fa-file-pdf" style="font-size:20px;margin-right: 2px;"></i> Gerar Pdf da Rifa</a>
                                </div>
