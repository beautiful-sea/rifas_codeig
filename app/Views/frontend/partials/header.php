...
<head>
    ...
    <?php if (isset($pixels) && !empty($pixels)) : ?>
        ...
        <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=3278217582446945&ev=PageView&noscript=1" /></noscript>
        <!-- End Meta Pixel Code -->
        ...
        <div class="container" id="menu">
            <div class="logo">
                <a href="<?php echo base_url('/') ?>">
                    <img src="<?= $url_da_imagem ?>" style="width: 100px !important; height: 50px !important; margin-left: 30px;" alt="Logotipo" width="100" height="50">
                </a>
            </div>
            ...
            <nav>
                <ul>
                    <span onclick="toggleMyRequestModal()" class="badge bg-warning" style="background-color: green; color: #fff;cursor: pointer;padding: 5px;border-radius: 10px;padding-top: 8px;padding-bottom: 8px;"><i class="fas fa-search" style="font-size: 14px;color: #fff;margin-left: 5px;margin-right: 5px;cursor:pointer;"></i>&nbsp;Meus Números</span>
            ...
            <nav id="menu_mobile" onclick="toggleMyRequestModal()" style="margin-left: 100px;">
                <span class="badge bg-warning" style="background-color: green; color: #fff;padding: 5px;border-radius: 10px;padding-top: 8px;padding-bottom: 8px;"><i class="fas fa-search" style="font-size: 14px;color: #fff;margin-left: 5px;margin-right: 5px;"></i>&nbsp;Meus Números</span>
