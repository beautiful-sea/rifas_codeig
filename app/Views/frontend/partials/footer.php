...
<div class="block__install" id="BlockInstall">
    <div class="inner">
        ...
        <div class="name">
            <span class="title">Desenvolvido por</span>
...
<footer>
    ...
    <p><a href="https://wa.me/5561999999999" target="_blank">  Meu nome aqui ❤️</a></p>

</footer>

<footer>

    <a href="#" target="_blank" class="p-3 cursor-pointer">
<i class="fab fa-instagram text-raffle-900 dark:text-raffle on-hover text-2xl" aria-hidden="true"></i>
</a>
...
<script>
    ...
    document.querySelector('.modal_my_requests').onsubmit = async function(e){
        ...
        if(phone){
            ...
            let res = await fetch(`${url}/meus-pedidos?phone=${phone}`, {
                method: 'POST',
                headers: {
